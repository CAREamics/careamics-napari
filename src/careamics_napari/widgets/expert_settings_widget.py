...
from careamics_napari.utils import get_default_settings, get_losses, get_pms
...
class TrainingSettingsWidget(QDialog):
    ...
    def __init__(self, parent, is_3D=False):
        ...
        use_n2v2 = (
            default_settings["blurpool"] == True
            and default_settings["skip_skipone"] == True
            and default_settings["n2v_manipulator"] == "median"
        )
        use_augment = True
        n_val = 5
        ...
        desc_n_validation = (
            "Number of patches used for validation. This is only used when no\n"
        ...
        desc_augment = (
            "If checked, augmentation will be applied to the training patches. Note\n"
        ...
        desc_n2v2 = (
            "If checked, the model will use N2V2, a version of N2V that mitigates\n"
        ...
        self.unet_depth = create_int_spinbox(
            value=unet_n_depth, min_value=2, max_value=5
        )
        ...
        self.unet_kernelsize = create_int_spinbox(
            value=unet_kern_size, min_value=3, max_value=9, step=2
        )
        ...
        desc_unet_n_first = (
            "Number of convolution filters for first U-Net resolution level\n"
        ...
        desc_unet_residuals = (
            "If checked, model will internally predict the residual w.r.t.\n"
        ...
        self.train_learning_rate.setValue(
            train_learning_rate
        )  # TODO: bug? cannot be set in create_double_spinbox.
        ...
        self.n2v_perc_pix = create_double_spinbox(
            value=n2v_perc_pix, step=0.001, max_value=100, n_decimal=3
        )
        ...
        self.n2v_neighborhood_radius = create_int_spinbox(
            value=n2v_neighborhood_radius, min_value=2, step=1, max_value=17
        )
        ...
        desc_single_net = (
            "Enabling this creates a unet for each channel and each channel will be "
        ...
        self.load_model_button.native.setToolTip(
        ...
        desc_structn2v = (
            "Mask for structN2V, a N2V flavor which removes structural noise along\n"
        ...
        self.structN2V_mask.textChanged.connect(
            self._on_structn2v_mask_change
        )  # remove augmentation if mask
